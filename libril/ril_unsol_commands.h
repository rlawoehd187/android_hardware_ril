...
*/
    ...
    {RIL_UNSOL_SKY_DATA_EVENT_INFO, responseInts, WAKE_PARTIAL}, /*FEATURE_SKY_DS_QMI_DATA_PATH_UNSOL*/
    {RIL_UNSOL_PBM_SIM_INIT_DONE, responseString, WAKE_PARTIAL},    /* FEATURE_QCRIL_PBM_SKY */
